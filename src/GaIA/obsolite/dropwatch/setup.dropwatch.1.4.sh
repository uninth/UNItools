...
# 
#
#                                     Fri Jun 10 11:01:57 CEST 2016
# Preample
# --------
# This script is the documentation for how dropwatch 1.4 was downloaded,
...
# All configuration files:	/var/opt/UNItools/etc/dropwatch
# All relevant documentation:	/var/opt/UNItools/docs/dropwatch.1.4
# 
...
# cd /lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/dropwatch
# 
#  1	Download the package dropwatch, and read the package documentation,
# 	usually README and INSTALL.
# 
#wget --no-check-certificate -N https://fedorahosted.org/releases/d/r/dropwatch/dropwatch-1.4.tbz2
# 
bunzip2 -c dropwatch-1.4.tbz2 |tar xvf -
# 
...
URL="https://fedorahosted.org/releases/d/r/dropwatch/dropwatch-1.4.tbz2"
PKG="dropwatch"
VER="1.4"
...
VENDOR="https://fedorahosted.org/releases/d/r/dropwatch/dropwatch-1.4.tbz2"

# Local source location
SRC="dropwatch-1.4.tbz2"
...
# 
# 	If dropwatch is made with automake and configure then
# 
# 	pkg_conbat -n ./CFG
# 
...
# 	/var/opt/UNItools
# 	If dropwatch requires something else to compile, please correct the
# 	section that writes to CFG.
# 	The new files are then moved to dropwatch.1.4.install.tmp - which
# 	will be wiped first.
# 	Copy extra files with ''install_more'' which sould add the files
# 	to /var/opt/UNItools/ ...
# 
# 	If dropwatch requires a start/stop script, then it will have to be made
...
# 
# pkg_setup https://fedorahosted.org/releases/d/r/dropwatch/dropwatch-1.4.tbz2 1.4 dropwatch
# 
