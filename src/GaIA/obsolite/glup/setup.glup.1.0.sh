...
# 
#
#                                     Fri Jun 10 11:47:22 CEST 2016
# Preample
# --------
# This script is the documentation for how glup 1.0 was downloaded,
...
# All configuration files:	/var/opt/UNItools/etc/glup
# All relevant documentation:	/var/opt/UNItools/docs/glup.1.0
# 
...
# cd /lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/glup
# 
#  1	Download the package glup, and read the package documentation,
# 	usually README and INSTALL.
# 
wget -N http://staff.washington.edu/corey/gulp/gulp.tgz
# 
/bin/gtar xvzf gulp.tgz
# 
...
URL="http://staff.washington.edu/corey/gulp/gulp.tgz"
PKG="glup"
VER="1.0"
...
VENDOR="http://staff.washington.edu/corey/gulp/gulp.tgz"
...
# 
# 	If glup is made with automake and configure then
# 
# 	pkg_conbat -n ./CFG
# 
...
# 	/var/opt/UNItools
# 	If glup requires something else to compile, please correct the
# 	section that writes to CFG.
# 	The new files are then moved to glup.1.0.install.tmp - which
# 	will be wiped first.
# 	Copy extra files with ''install_more'' which sould add the files
# 	to /var/opt/UNItools/ ...
# 
# 	If glup requires a start/stop script, then it will have to be made
...
# 
# pkg_setup http://staff.washington.edu/corey/gulp/gulp.tgz 1.0 glup
# 
