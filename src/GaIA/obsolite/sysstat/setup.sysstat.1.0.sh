...
# 
#
#                                     Wed Sep 30 12:03:12 CEST 2015
# Preample
# --------
# This script is the documentation for how sysstat 1.0 was downloaded,
...
# All configuration files:	/var/opt/UNItools/etc/sysstat
# All relevant documentation:	/var/opt/UNItools/docs/sysstat.1.0
# 
...
# cd /lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/sysstat
# 
#  1	Download the package sysstat, and read the package documentation,
# 	usually README and INSTALL.
# 
wget --no-check-certificate -N https://github.com/sysstat/sysstat/archive/master.zip
# 
# /bin/gtar xvzf master.zip
# 
...
URL="https://github.com/sysstat/sysstat/archive/master.zip"
PKG="sysstat"
VER="1.0"
...
VENDOR="https://github.com/sysstat/sysstat/archive/master.zip"
...
# 
# 	If sysstat is made with automake and configure then
# 
# 	pkg_conbat -n ./CFG
# 
...
# 	/var/opt/UNItools
# 	If sysstat requires something else to compile, please correct the
# 	section that writes to CFG.
# 	The new files are then moved to sysstat.1.0.install.tmp - which
# 	will be wiped first.
# 	Copy extra files with ''install_more'' which sould add the files
# 	to /var/opt/UNItools/ ...
# 
# 	If sysstat requires a start/stop script, then it will have to be made
...
# 
# pkg_setup https://github.com/sysstat/sysstat/archive/master.zip 1.0 sysstat
# 
