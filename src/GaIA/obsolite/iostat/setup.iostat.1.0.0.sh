...
# 
#
#                                     Wed Sep 30 11:44:05 CEST 2015
# Preample
# --------
# This script is the documentation for how iostat 1.0.0 was downloaded,
...
# All configuration files:	/var/opt/UNItools/etc/iostat
# All relevant documentation:	/var/opt/UNItools/docs/iostat.1.0.0
# 
...
# cd /lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/iostat
# 
#  1	Download the package iostat, and read the package documentation,
# 	usually README and INSTALL.
# 
# wget -N http://downloads.sourceforge.net/project/iostat/iostat-1.0.0.tar.gz
# 
# /bin/gtar xvzf iostat-1.0.0.tar.gz
# 
...
URL="http://downloads.sourceforge.net/project/iostat/iostat-1.0.0.tar.gz"
PKG="iostat"
VER="1.0.0"
...
VENDOR="http://downloads.sourceforge.net/project/iostat/iostat-1.0.0.tar.gz"
...
# 
# 	If iostat is made with automake and configure then
# 
 	pkg_conbat -n ./CFG
# 
...
# 	/var/opt/UNItools
# 	If iostat requires something else to compile, please correct the
# 	section that writes to CFG.
# 	The new files are then moved to iostat.1.0.0.install.tmp - which
# 	will be wiped first.
# 	Copy extra files with ''install_more'' which sould add the files
# 	to /var/opt/UNItools/ ...
# 
# 	If iostat requires a start/stop script, then it will have to be made
...
# 
# pkg_setup http://downloads.sourceforge.net/project/iostat/iostat-1.0.0.tar.gz 1.0.0 iostat
# 
