...
# 
#
#                                     Mon Apr 18 12:14:05 CEST 2016
# Preample
# --------
# This script is the documentation for how lighthttpd 1.4.39 was downloaded,
...
# All configuration files:	/var/opt/UNItools/etc/lighthttpd
# All relevant documentation:	/var/opt/UNItools/docs/lighthttpd.1.4.39
# 
...
# cd /lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/lighthttpd
# 
#  1	Download the package lighthttpd, and read the package documentation,
# 	usually README and INSTALL.
# 
#wget -N http://download.lighttpd.net/lighttpd/releases-1.4.x/lighttpd-1.4.39.tar.gz
# 
#/bin/gtar xvzf lighttpd-1.4.39.tar.gz
# 
...
VENDOR="http://download.lighttpd.net/lighttpd/releases-1.4.x/lighttpd-1.4.39.tar.gz"
...
CONFIGURE="./configure --prefix=$ROOT --enable-static --sbindir=$ROOT/bin --with-openssl=/usr/local/ssl --with-openssl-libs=/usr/local/ssl"
BUILD="make"
...
# 
# 	If lighthttpd is made with automake and configure then
# 
	(
	. ./CFG
...
# 	/var/opt/UNItools
# 	If lighthttpd requires something else to compile, please correct the
# 	section that writes to CFG.
# 	The new files are then moved to lighthttpd.1.4.39.install.tmp - which
# 	will be wiped first.
# 	Copy extra files with ''install_more'' which sould add the files
# 	to /var/opt/UNItools/ ...
# 
# 	If lighthttpd requires a start/stop script, then it will have to be made
...
# 
# pkg_setup http://download.lighttpd.net/lighttpd/releases-1.4.x/lighttpd-1.4.39.tar.gz 1.4.39 lighthttpd
# 
