...
# 
#
#                                     Wed Aug 26 14:54:01 CEST 2015
# Preample
# --------
# This script is the documentation for how openssl 1.0.2d was downloaded,
...
# All configuration files:	/var/opt/UNItools/etc/openssl
# All relevant documentation:	/var/opt/UNItools/docs/openssl.1.0.2d
# 
...
# cd /lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/openssl
# 
#  1	Download the package openssl, and read the package documentation,
# 	usually README and INSTALL.
# 
wget -N http://www.openssl.org/source/openssl-1.0.2d.tar.gz
# 
/bin/gtar xvzf openssl-1.0.2d.tar.gz
# 
...
VENDOR="https://www.openssl.org/source/openssl-1.0.2d.tar.gz"
...
# 
# 	If openssl is made with automake and configure then
# 
# 	pkg_conbat -n ./CFG
# 
...
# 	/var/opt/UNItools
# 	If openssl requires something else to compile, please correct the
# 	section that writes to CFG.
# 	The new files are then moved to openssl.1.0.2d.install.tmp - which
# 	will be wiped first.
# 	Copy extra files with ''install_more'' which sould add the files
# 	to /var/opt/UNItools/ ...
# 
# 	If openssl requires a start/stop script, then it will have to be made
...
# 
# pkg_setup https://www.openssl.org/source/openssl-1.0.2d.tar.gz 1.0.2d openssl
# 
