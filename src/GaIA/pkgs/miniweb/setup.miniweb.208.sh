...
# 
#
#                                     Mon Apr 18 12:43:55 CEST 2016
# Preample
# --------
# This script is the documentation for how miniweb 208 was downloaded,
...
# All configuration files:	/var/opt/UNItools/etc/miniweb
# All relevant documentation:	/var/opt/UNItools/docs/miniweb.208
# 
...
# cd /lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/miniweb
# 
#  1	Download the package miniweb, and read the package documentation,
# 	usually README and INSTALL.
# 
#  wget --no-check-certificate -N https://sourceforge.net/code-snapshots/svn/m/mi/miniweb/code/miniweb-code-208.zip
# 
#  unzip miniweb-code-208.zip
# 
...
URL="https://sourceforge.net/code-snapshots/svn/m/mi/miniweb/code/miniweb-code-208.zip"
PKG="miniweb"
VER="208"
...
VENDOR="https://sourceforge.net/code-snapshots/svn/m/mi/miniweb/code/miniweb-code-208.zip"

# Local source location
SRC="miniweb-code-208.zip"
...
# 
# 	If miniweb is made with automake and configure then
# 
	(

		cd miniweb-code-208
		test -f Makefile.org || cp Makefile Makefile.org
		sed 's/-Wunused-result//g' Makefile.org > Makefile
		make
	)
...
# 	/var/opt/UNItools
# 	If miniweb requires something else to compile, please correct the
# 	section that writes to CFG.
# 	The new files are then moved to miniweb.208.install.tmp - which
# 	will be wiped first.
# 	Copy extra files with ''install_more'' which sould add the files
# 	to /var/opt/UNItools/ ...
# 
# 	If miniweb requires a start/stop script, then it will have to be made
...
# 
# pkg_setup https://sourceforge.net/code-snapshots/svn/m/mi/miniweb/code/miniweb-code-208.zip 208 miniweb
# 
