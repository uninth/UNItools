...
# 
#
#                                      Wed Mar 19 14:50:36 CET 2014
# Preample
# --------
# This script is the documentation for how ifstatus 1.1.0 was downloaded,
...
# All configuration files:	/var/opt/UNItools/etc/ifstatus
# All relevant documentation:	/var/opt/UNItools/docs/ifstatus.1.1.0
# 
...
# cd /lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/ifstatus
# 
#  1	Download the package ifstatus, and read the package documentation,
# 	usually README and INSTALL.
# 
# wget -N http://ifstatus.sourceforge.net/download/ifstatus-v1.1.0.tar.gz
# 
# /bin/gtar xvzf ifstatus-v1.1.0.tar.gz
# 
...
URL="http://ifstatus.sourceforge.net/download/ifstatus-v1.1.0.tar.gz"
PKG="ifstatus"
VER="1.1.0"
...
VENDOR="http://ifstatus.sourceforge.net/download/ifstatus-v1.1.0.tar.gz"
...
# 
# 	If ifstatus is made with automake and configure then
# 
 	pkg_conbat -n ./CFG
# 
...
# 	/var/opt/UNItools
# 	If ifstatus requires something else to compile, please correct the
# 	section that writes to CFG.
# 	The new files are then moved to ifstatus.1.1.0.install.tmp - which
# 	will be wiped first.
# 	Copy extra files with ''install_more'' which sould add the files
# 	to /var/opt/UNItools/ ...
# 
# 	If ifstatus requires a start/stop script, then it will have to be made
...
# 
# pkg_setup http://ifstatus.sourceforge.net/download/ifstatus-v1.1.0.tar.gz 1.1.0 ifstatus
# 
