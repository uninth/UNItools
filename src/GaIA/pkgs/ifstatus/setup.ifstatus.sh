...
# Konfiguration: /var/opt/UNItools/etc/ifstatus
# Dokumentation: /var/opt/UNItools/docs/ifstatus.1.1.0
# 
# Det er *ikke* programpakker i Linux format (pkg) men blot en
# installation af programmet ifstatus.
# 
#  1	Download programpakken ifstatus til /home/projects/UNItools/src/Linux/2.4.21-20cpsmp/pkgs/ifstatus.
# 	Læs hvordan programpakken oversættes og installeres i dokumentationen
# 	for programpakken (typisk README og INSTALL).
# 
 	wget -N http://freshmeat.net/redir/ifstatus/62567/url_tgz/ifstatus-v1.1.0.tar.gz
# 
...
# 	som html, txt og pdf og gemmes i docs/ifstatus.1.1.0.  Se efter
...
# 	kopiere de relevante dokumenter til ifstatus.1.1.0.install.tmp.
# 
