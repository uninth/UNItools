...
# 0.35.2  2005/06 Again repair HTML. Thanks to Lars Mueller.


use strict;

my $version = '0.35.2 2005/07/07';
...
sub printnet {
    ...
    printline ("Network",   &bintodq($n) . "/$mask", ($n,$mask,$bcolor,1),  " ($sfont$ccolor" . $type. "$ncolor)" );
