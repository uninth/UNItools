...
# Konfiguration: /var/opt/UNItools/etc/scripts
# Dokumentation: /var/opt/UNItools/docs/scripts.1.0
# 
# Det er *ikke* programpakker i Linux format (pkg) men blot en
# installation af programmet scripts.
# 
#  1	Download programpakken scripts til /lan/ssi/projects/UNItools/src/Linux/2.4.21-20cpsmp/pkgs/scripts.
# 	Læs hvordan programpakken oversættes og installeres i dokumentationen
# 	for programpakken (typisk README og INSTALL).
# 
# 	wget -N http://apollon.ssi.uni-c.dk
# 
# 	/bin/gtar xvzf apollon.ssi.uni-c.dk
# 
...
# 	som html, txt og pdf og gemmes i docs/scripts.1.0.  Se efter
...
# 	kopiere de relevante dokumenter til scripts.1.0.install.tmp.
# 
