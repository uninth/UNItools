...
# 
#
#                                     Thu May  7 09:54:45 CEST 2015
# Preample
# --------
# This script is the documentation for how tcpstat 1.5 was downloaded,
...
# All configuration files:	/var/opt/UNItools/etc/tcpstat
# All relevant documentation:	/var/opt/UNItools/docs/tcpstat.1.5
# 
...
# cd /lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/tcpstat
# 
#  1	Download the package tcpstat, and read the package documentation,
# 	usually README and INSTALL.
# 
wget -N http://www.frenchfries.net/paul/tcpstat/tcpstat-1.5.tar.gz
# 
/bin/gtar xvzf tcpstat-1.5.tar.gz
# 
...
URL="http://www.frenchfries.net/paul/tcpstat/tcpstat-1.5.tar.gz"
PKG="tcpstat"
VER="1.5"
...
VENDOR="http://www.frenchfries.net/paul/tcpstat/tcpstat-1.5.tar.gz"
...
#	This will produce a number of errors, but the binary statically linked
#	tcpstat works on GAiA (32 and 64 bit) and SPLAT.

# 
# 	If tcpstat is made with automake and configure then
# 
 	pkg_conbat -n ./CFG
# 
...
# 	/var/opt/UNItools
# 	If tcpstat requires something else to compile, please correct the
# 	section that writes to CFG.
# 	The new files are then moved to tcpstat.1.5.install.tmp - which
# 	will be wiped first.
# 	Copy extra files with ''install_more'' which sould add the files
# 	to /var/opt/UNItools/ ...
# 
# 	If tcpstat requires a start/stop script, then it will have to be made
...
# 
# pkg_setup http://www.frenchfries.net/paul/tcpstat/tcpstat-1.5.tar.gz 1.5 tcpstat
# 
