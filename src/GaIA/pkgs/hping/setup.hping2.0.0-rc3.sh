...
# cd /lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/hping
# 
...
PKG="hping"
VER="2.0.0-rc3"
NAME="network tool able to send custom ICMP/UDP/TCP packets"
VENDOR="antirez@invece.org"
SRC="hping2.0.0-rc3"
...
# 
# 	The installation is a little more complex:
