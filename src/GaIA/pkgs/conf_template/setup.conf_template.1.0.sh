...
# 
#
#                                      Wed Mar 19 13:03:50 CET 2014
# Preample
# --------
# This script is the documentation for how conf_template 1.0 was downloaded,
...
# All configuration files:	/var/opt/UNItools/etc/conf_template
# All relevant documentation:	/var/opt/UNItools/docs/conf_template.1.0
# 
...
# cd /lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/conf_template
# 
#  1	Download the package conf_template, and read the package documentation,
# 	usually README and INSTALL.
# 
# wget -N http://cppkg.haugaard.net/conf_template.1.0
# 
# /bin/gtar xvzf conf_template.1.0
# 
...
cat << "END_OF_CFG" > CFG
# Dummy
URL="http://cppkg.haugaard.net/conf_template.1.0"
PKG="conf_template"
VER="1.0"
NAME="SPLAT dot-profiles and config files for the smtp client"
VENDOR="I2"
SRC="conf_template.1.0"
ROOT="/var/opt/UNItools"
CONFIGURE="/bin/echo done"
BUILD="make"
INSTALL="make install"
INSTALL_MORE=install_more.sh
...
# 
# 	If conf_template is made with automake and configure then
# 
 	pkg_conbat -n ./CFG
# 
...
# 	/var/opt/UNItools
# 	If conf_template requires something else to compile, please correct the
# 	section that writes to CFG.
# 	The new files are then moved to conf_template.1.0.install.tmp - which
# 	will be wiped first.
# 	Copy extra files with ''install_more'' which sould add the files
# 	to /var/opt/UNItools/ ...
# 
# 	If conf_template requires a start/stop script, then it will have to be made
...
# 
# pkg_setup http://cppkg.haugaard.net/conf_template.1.0 1.0 conf_template
# 
