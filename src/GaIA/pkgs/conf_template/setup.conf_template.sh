...
# Konfiguration: /var/opt/UNItools/etc/conf_template
# Dokumentation: /var/opt/UNItools/docs/conf_template.1.0
# 
# Det er *ikke* programpakker i Linux format (pkg) men blot en
# installation af programmet conf_template.
# 
#  1	Download programpakken conf_template til /lan/ssi/projects/UNItools/src/Linux/2.4.21-20cpsmp/pkgs/conf_template.
# 	Læs hvordan programpakken oversættes og installeres i dokumentationen
# 	for programpakken (typisk README og INSTALL).
# 
# 	wget -N http://cppkg.haugaard.net
# 
# 	/bin/gtar xvzf cppkg.haugaard.net
# 
...
# 	som html, txt og pdf og gemmes i docs/conf_template.1.0.  Se efter
...
# 	kopiere de relevante dokumenter til conf_template.1.0.install.tmp.
# 
