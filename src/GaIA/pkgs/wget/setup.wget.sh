...
# Konfiguration: /var/opt/UNItools/etc/wget
# Dokumentation: /var/opt/UNItools/docs/wget.1.10.2
# 
# Det er *ikke* programpakker i Linux format (pkg) men blot en
# installation af programmet wget.
# 
#  1	Download programpakken wget til /lan/ssi/projects/UNItools/src/Linux/2.4.21-20cpsmp/pkgs/wget.
# 	Læs hvordan programpakken oversættes og installeres i dokumentationen
# 	for programpakken (typisk README og INSTALL).
# 
# 	wget -N http://freshmeat.net/redir/wget/3569/url_tgz/wget-1.10.2.tar.gz
# 
# 	/bin/gtar xvzf wget-1.10.2.tar.gz
# 
...
# 	som html, txt og pdf og gemmes i docs/wget.1.10.2.  Se efter
...
# 	kopiere de relevante dokumenter til wget.1.10.2.install.tmp.
# 
