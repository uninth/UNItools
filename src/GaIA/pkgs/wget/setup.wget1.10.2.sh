...
# cd /lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/wget
# 
...
URL="http://freshmeat.net/redir/wget/3569/url_tgz/wget-1.10.2.tar.gz"
PKG="wget"
VER="1.10.2"

# Description used internally
NAME="non-interactive network downloader"

# The creator/copyright holder
VENDOR="see AUTHORS"

# Local source location
SRC="/lan/ssi/projects/UNItools/src/Linux/2.4.21-20cpsmp/pkgs/wget/wget-1.10.2"

# prefix for ''make install' Do not change
ROOT="/var/opt/UNItools"

# Arguments to configure, build command and installation command
CONFIGURE="configure --with-ssl --prefix=/var/opt/UNItools --mandir=/var/opt/UNItools/share/man --bindir=/var/opt/UNItools/bin"
BUILD="make"
