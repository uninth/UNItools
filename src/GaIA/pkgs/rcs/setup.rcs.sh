...
# Konfiguration: /var/opt/UNItools/etc/rcs
# Dokumentation: /var/opt/UNItools/docs/rcs.5.8
# 
# Det er *ikke* programpakker i Linux format (pkg) men blot en
# installation af programmet rcs.
# 
#  1	Download programpakken rcs til /lan/ssi/projects/UNItools/src/Linux/2.4.21-20cpsmp/pkgs/rcs.
# 	Læs hvordan programpakken oversættes og installeres i dokumentationen
# 	for programpakken (typisk README og INSTALL).
# 
 	wget -N http://mirrors.dotsrc.org/gnu/rcs/rcs-5.8.tar.gz
# 
 	/bin/gtar xvzf rcs-5.8.tar.gz
# 
...
# 	som html, txt og pdf og gemmes i docs/rcs.5.8.  Se efter
...
# 	kopiere de relevante dokumenter til rcs.5.8.install.tmp.
# 
