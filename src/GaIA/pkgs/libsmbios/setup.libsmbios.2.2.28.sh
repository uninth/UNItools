...
# 
#
#                                      Wed Mar 26 11:45:21 CET 2014
# Preample
# --------
# This script is the documentation for how libsmbios 2.2.28 was downloaded,
...
# All configuration files:	/var/opt/UNItools/etc/libsmbios
# All relevant documentation:	/var/opt/UNItools/docs/libsmbios.2.2.28
# 
...
# cd /lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/libsmbios
# 
#  1	Download the package libsmbios, and read the package documentation,
# 	usually README and INSTALL.
# 
# wget -N http://linux.dell.com/libsmbios/download/libsmbios/libsmbios-2.2.28/libsmbios-2.2.28.tar.gz
# 
# /bin/gtar xvzf libsmbios-2.2.28.tar.gz
# 
...
URL="http://linux.dell.com/libsmbios/download/libsmbios/libsmbios-2.2.28/libsmbios-2.2.28.tar.gz"
PKG="libsmbios"
VER="2.2.28"
...
SRC="libsmbios-2.2.28"

# prefix for ''make install' Do not change
ROOT=/var/opt/UNItools

# Arguments to configure, build command and installation command
CONFIGURE="configure --prefix=$ROOT --mandir=$ROOT/share/man --bindir=$ROOT/bin --sbindir=$ROOT/bin --disable-as-needed"
BUILD="make"
...
# 
# 	If libsmbios is made with automake and configure then
# 
	(
	. ./CFG
...
# 	/var/opt/UNItools
# 	If libsmbios requires something else to compile, please correct the
# 	section that writes to CFG.
# 	The new files are then moved to libsmbios.2.2.28.install.tmp - which
# 	will be wiped first.
# 	Copy extra files with ''install_more'' which sould add the files
# 	to /var/opt/UNItools/ ...
# 
# 	If libsmbios requires a start/stop script, then it will have to be made
...
# 
# pkg_setup http://linux.dell.com/libsmbios/download/libsmbios/libsmbios-2.2.28/libsmbios-2.2.28.tar.gz 2.2.28 libsmbios
# 
