...
# Konfiguration: /var/opt/UNItools/etc/libsmbios
# Dokumentation: /var/opt/UNItools/docs/libsmbios.2.2.19
# 
# Det er *ikke* programpakker i Linux format (pkg) men blot en
# installation af programmet libsmbios.
# 
#  1	Download programpakken libsmbios til /lan/ssi/projects/UNItools/src/Linux/2.4.21-20cpsmp/pkgs/libsmbios.
...
# 	som html, txt og pdf og gemmes i docs/libsmbios.2.2.19.  Se efter
...
# 	kopiere de relevante dokumenter til libsmbios.2.2.19.install.tmp.
# 
