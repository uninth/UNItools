...
# 
#
#                                      Wed Mar 26 11:30:45 CET 2014
# Preample
# --------
# This script is the documentation for how libsmbios 2.2.19 was downloaded,
...
# All relevant documentation:	/var/opt/UNItools/docs/libsmbios.2.2.19
# 
...
# 
# wget -N http://linux.dell.com/libsmbios/download/libsmbios/libsmbios-2.2.19/libsmbios-2.2.19.tar.gz
# 
# /bin/gtar xvzf libsmbios-2.2.19.tar.gz
# 
...
# 	The new files are then moved to libsmbios.2.2.19.install.tmp - which
# 	will be wiped first.
...
# 
# pkg_setup http://linux.dell.com/libsmbios/download/libsmbios/libsmbios-2.2.19/libsmbios-2.2.19.tar.gz 2.2.19 libsmbios
# 
