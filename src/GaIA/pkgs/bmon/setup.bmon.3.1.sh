...
# 
#
#                                      Wed Mar 19 11:44:55 CET 2014
# Preample
# --------
# This script is the documentation for how bmon 3.1 was downloaded,
...
# All relevant documentation:	/var/opt/UNItools/docs/bmon.3.1
# 
...
# 
# wget -N http://www.carisma.slowglass.com/~tgr/bmon/files/bmon-3.1.tar.gz
# wget -N http://savannah.nongnu.org/download/confuse/confuse-2.7.tar.gz
# wget -N http://www.carisma.slowglass.com/~tgr/libnl/files/libnl-3.2.24.tar.gz
# install in /usr/local

export PKG_CONFIG_PATH=/usr/local/lib/pkgconfig/

# 
# /bin/gtar xvzf bmon-3.1.tar.gz
# 
...
# 	The new files are then moved to bmon.3.1.install.tmp - which
# 	will be wiped first.
...
# 
# pkg_setup http://www.carisma.slowglass.com/~tgr/bmon/files/bmon-3.1.tar.gz 3.1 bmon
# 
