...
# 
#
#                                      Wed Mar 19 15:05:50 CET 2014
# Preample
# --------
# This script is the documentation for how iftop 0.16 was downloaded,
...
# All configuration files:	/var/opt/UNItools/etc/iftop
# All relevant documentation:	/var/opt/UNItools/docs/iftop.0.16
# 
...
# cd /lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/iftop
# 
#  1	Download the package iftop, and read the package documentation,
...
URL="http://www.ex-parrot.com/~pdw/iftop/download/iftop-0.16.tar.gz"
PKG="iftop"
VER="0.16"
...
VENDOR="http://www.ex-parrot.com/~pdw/iftop/download/iftop-0.16.tar.gz"
...
# 
# 	If iftop is made with automake and configure then
# 
 	pkg_conbat -n ./CFG
# 
...
# 	/var/opt/UNItools
# 	If iftop requires something else to compile, please correct the
# 	section that writes to CFG.
# 	The new files are then moved to iftop.0.16.install.tmp - which
# 	will be wiped first.
# 	Copy extra files with ''install_more'' which sould add the files
# 	to /var/opt/UNItools/ ...
# 
# 	If iftop requires a start/stop script, then it will have to be made
...
# 
# pkg_setup http://www.ex-parrot.com/~pdw/iftop/download/iftop-0.16.tar.gz 0.16 iftop
# 
