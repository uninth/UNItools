...
# 
#
#                                      Wed Mar 26 16:13:44 CET 2014
# Preample
# --------
# This script is the documentation for how saidar 0.14 was downloaded,
...
# All configuration files:	/var/opt/UNItools/etc/saidar
# All relevant documentation:	/var/opt/UNItools/docs/saidar.0.14
# 
...
# cd /lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/saidar
# 
#  1	Download the package saidar, and read the package documentation,
...
URL="http://www.mirrorservice.org/sites/ftp.i-scream.org/pub/i-scream/libstatgrab/libstatgrab-0.14.tar.gz"
PKG="saidar"
VER="0.14"

# Description used internally
NAME="curses-based tool for viewing system statistics"

# The creator/copyright holder
VENDOR="http://www.i-scream.org"

# Local source location
SRC="libstatgrab-0.14"
...
# 
# 	If saidar is made with automake and configure then
# 
# 	pkg_conbat -n ./CFG
# 
...
# 	/var/opt/UNItools
# 	If saidar requires something else to compile, please correct the
# 	section that writes to CFG.
# 	The new files are then moved to saidar.0.14.install.tmp - which
# 	will be wiped first.
# 	Copy extra files with ''install_more'' which sould add the files
# 	to /var/opt/UNItools/ ...
# 
# 	If saidar requires a start/stop script, then it will have to be made
...
# 
# pkg_setup http://www.mirrorservice.org/sites/ftp.i-scream.org/pub/i-scream/libstatgrab/libstatgrab-0.14.tar.gz 0.14 saidar
# 
