...
const char GVNTBEG[]="<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\"><tr><td><img src=\"";
const char GVNTMID[]="\"/></td></tr><tr><td>";
const char GVNTEND[]="</td></tr></table>";
const char GVNIMG_SOURCE[]="source.png";
const char GVNIMG_TRGOPEN[]="dest.png";
const char GVNIMG_TRGCLOSED[]="dest_closed.png";
const char GVNIMG_TRGFILTERED[]="dest_prohibited.png";
const char GVNIMG_ANOMALY1[]="firewall_smart.png";
const char GVNIMG_ANOMALY2[]="firewall_stupid.png";
const char GVNIMG_ANOMALY3[]="firewall_stupid.png";
const char GVNIMG_REGULAR[]="router.png";
const char GVNIMG_HOLE[]="router_cloaked.png";
const char GVNIMG_SEAM[]="router_seam.png";
#if defined(WIN32) || defined(_WIN32)
const char DIRECTORY_SPLITTER='\\';
#else
const char DIRECTORY_SPLITTER='/';
#endif
/*---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------*/
#define INCSIZE	500
char * addtostringbuf(char * buf, size_t * bufsz, char * addstr)
{
	if(!buf || !(*bufsz))
	{
		buf=malloc(INCSIZE);
...
/*---------------------------------------------------------------------------*/
char * addNodeToRouteMap(char * routemap, size_t * routemapsz, char * prevlevelnodes, char ** currlevelnodes, size_t * currlevelnodessz, char * node)
{
	char * pnode, * pnodeend;
	char pathbuff[100];
...
void GraphVizOutput(lft_session_params * sess)
{
	int reply,noreply,neglstart,neglend,anomtype,hopno,maxhop,rankcount=1,icmpcode,holecount=0;
