...
# Konfiguration: /var/opt/UNItools/etc/edge_backup
# Dokumentation: /var/opt/UNItools/docs/edge_backup.1.0
# 
# Det er *ikke* programpakker i Linux format (pkg) men blot en
# installation af programmet edge_backup.
# 
#  1	Download programpakken edge_backup til /lan/ssi/projects/UNItools/src/Linux/2.4.21-20cpsmp/pkgs/edge_backup.
...
# 	som html, txt og pdf og gemmes i docs/edge_backup.1.0.  Se efter
...
# 	kopiere de relevante dokumenter til edge_backup.1.0.install.tmp.
# 
