...
# Konfiguration: /var/opt/UNItools/etc/lft
# Dokumentation: /var/opt/UNItools/docs/lft.2.5
# 
# Det er *ikke* programpakker i Linux format (pkg) men blot en
# installation af programmet lft.
# 
#  1	Download programpakken lft til /lan/ssi/projects/UNItools/src/Linux/2.4.21-20cpsmp/pkgs/lft.
# 	Læs hvordan programpakken oversættes og installeres i dokumentationen
# 	for programpakken (typisk README og INSTALL).
# 
# 	wget -N http://oppleman.com/lft/lft-2.5.tar.gz
# 
# 	/bin/gtar xvzf lft-2.5.tar.gz
# 
...
# 	som html, txt og pdf og gemmes i docs/lft.2.5.  Se efter
...
# 	kopiere de relevante dokumenter til lft.2.5.install.tmp.
# 
