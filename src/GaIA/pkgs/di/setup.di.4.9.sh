...
# 
#
#                                      Wed Mar 19 14:12:24 CET 2014
# Preample
# --------
# This script is the documentation for how di 4.9 was downloaded,
...
# All configuration files:	/var/opt/UNItools/etc/di
# All relevant documentation:	/var/opt/UNItools/docs/di.4.9
# 
...
# cd /lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/di
# 
#  1	Download the package di, and read the package documentation,
# 	usually README and INSTALL.
# 
# wget -N http://www.gentoo.com/di/di-4.9.tar.gz
# 
# /bin/gtar xvzf di-4.9.tar.gz
# 
...
# 
cat << "END_OF_CFG" > CFG
URL="http://www.gentoo.com/di/di-4.9.tar.gz"
PKG="di"
VER="4.9"
NAME="disk information utility"
VENDOR="Brad Lanam, Walnut Creek, CA, USA"
SRC="di-4.9"
ROOT="/var/opt/UNItools"
CONFIGURE="prefix=/var/opt/UNItools/ ./Build -mkc"
BUILD="make"
...
# 
# 	If di is made with automake and configure then
# 
 	pkg_conbat -n ./CFG
# 
...
# 	/var/opt/UNItools
# 	If di requires something else to compile, please correct the
# 	section that writes to CFG.
# 	The new files are then moved to di.4.9.install.tmp - which
# 	will be wiped first.
# 	Copy extra files with ''install_more'' which sould add the files
# 	to /var/opt/UNItools/ ...
# 
# 	If di requires a start/stop script, then it will have to be made
...
# 
# pkg_setup http://www.gentoo.com/di/di-4.9.tar.gz 4.9 di
# 
