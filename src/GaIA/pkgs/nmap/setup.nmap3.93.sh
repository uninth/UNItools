...
NAME="Network exploration tool and security scanner"

# The creator/copyright holder
VENDOR="Fyodor <fyodor@insecure.org>"

# Local source location
SRC="/lan/ssi/projects/UNItools/src/Linux/2.4.21-20cpsmp/pkgs/nmap/nmap-3.93"

# prefix for ''make install' Do not change
ROOT="/var/opt/UNItools"

# Arguments to configure, build command and installation command
CONFIGURE="configure --prefix=/var/opt/UNItools --mandir=/var/opt/UNItools/share/man --bindir=/var/opt/UNItools/bin --without-nmapfe --with-openssl=/usr/local/ssl/"
BUILD="make"
