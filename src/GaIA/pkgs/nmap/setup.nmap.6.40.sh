...
# 
#
#                                      Thu Mar 27 12:11:50 CET 2014
# Preample
# --------
# This script is the documentation for how nmap 6.40 was downloaded,
...
# All relevant documentation:	/var/opt/UNItools/docs/nmap.6.40
# 
...
# 
# wget -N http://nmap.org/dist/nmap-6.40.tgz
# 
# /bin/gtar xvzf nmap-6.40.tgz
# 
...
URL="http://nmap.org/dist/nmap-6.40.tgz"
PKG="nmap"
VER="6.40"
...
VENDOR="http://nmap.org/dist/nmap-6.40.tgz"
...
# 	The new files are then moved to nmap.6.40.install.tmp - which
# 	will be wiped first.
...
# 
# pkg_setup http://nmap.org/dist/nmap-6.40.tgz 6.40 nmap
# 
