...
# Konfiguration: /var/opt/UNItools/etc/nmap
# Dokumentation: /var/opt/UNItools/docs/nmap.3.93
# 
# Det er *ikke* programpakker i Linux format (pkg) men blot en
# installation af programmet nmap.
# 
#  1	Download programpakken nmap til /lan/ssi/projects/UNItools/src/Linux/2.4.21-20cpsmp/pkgs/nmap.
...
# 	som html, txt og pdf og gemmes i docs/nmap.3.93.  Se efter
...
# 	kopiere de relevante dokumenter til nmap.3.93.install.tmp.
# 
