...
# 
#
#                                      Thu Mar 27 15:34:08 CET 2014
# Preample
# --------
# This script is the documentation for how nmap 3.93 was downloaded,
...
# All configuration files:	/var/opt/UNItools/etc/nmap
# All relevant documentation:	/var/opt/UNItools/docs/nmap.3.93
# 
...
# cd /lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/nmap
# 
#  1	Download the package nmap, and read the package documentation,
# 	usually README and INSTALL.
# 
# wget -N http://www.insecure.org/nmap/dist/nmap-3.93.tgz
# 
# /bin/gtar xvzf nmap-3.93.tgz
# 
...
URL="http://www.insecure.org/nmap/dist/nmap-3.93.tgz"
PKG="nmap"
VER="3.93"
...
VENDOR="http://www.insecure.org/nmap/dist/nmap-3.93.tgz"
...
# 
# 	If nmap is made with automake and configure then
# 
# 	pkg_conbat -n ./CFG
# 
...
# 	/var/opt/UNItools
# 	If nmap requires something else to compile, please correct the
# 	section that writes to CFG.
# 	The new files are then moved to nmap.3.93.install.tmp - which
# 	will be wiped first.
# 	Copy extra files with ''install_more'' which sould add the files
# 	to /var/opt/UNItools/ ...
# 
# 	If nmap requires a start/stop script, then it will have to be made
...
# 
# pkg_setup http://www.insecure.org/nmap/dist/nmap-3.93.tgz 3.93 nmap
# 
