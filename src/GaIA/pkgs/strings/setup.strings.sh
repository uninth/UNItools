...
# Konfiguration: /var/opt/UNItools/etc/strings
# Dokumentation: /var/opt/UNItools/docs/strings.2.14
# 
# Det er *ikke* programpakker i Linux format (pkg) men blot en
# installation af programmet strings.
# 
#  1	Download programpakken strings til /lan/ssi/projects/UNItools/src/Linux/2.4.21-20cpsmp/pkgs/strings.
...
# 	som html, txt og pdf og gemmes i docs/strings.2.14.  Se efter
...
# 	kopiere de relevante dokumenter til strings.2.14.install.tmp.
# 
