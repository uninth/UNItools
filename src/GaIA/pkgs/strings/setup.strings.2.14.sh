...
# 
#
#                                      Wed Mar 19 10:31:25 CET 2014
# Preample
# --------
# This script is the documentation for how strings 2.14 was downloaded,
...
# All configuration files:	/var/opt/UNItools/etc/strings
# All relevant documentation:	/var/opt/UNItools/docs/strings.2.14
# 
...
# cd /lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/strings
# 
#  1	Download the package strings, and read the package documentation,
# 	usually README and INSTALL.
# 
# wget -N ftp://ftp.gnu.org/gnu/binutils/binutils-2.14.tar.gz
# 
# /bin/gtar xvzf binutils-2.14.tar.gz
# 
...
# 
cat << "END_OF_CFG" > CFG
URL="ftp://ftp.gnu.org/gnu/binutils/binutils-2.14.tar.gz"
PKG="strings"
VER="2.14"
NAME="print the strings of printable characters in files"
VENDOR="GNU"
SRC="binutils-2.14"
...
# 
# 	If strings is made with automake and configure then
# 
 	pkg_conbat -n ./CFG
# 
...
# 	/var/opt/UNItools
# 	If strings requires something else to compile, please correct the
# 	section that writes to CFG.
# 	The new files are then moved to strings.2.14.install.tmp - which
# 	will be wiped first.
# 	Copy extra files with ''install_more'' which sould add the files
# 	to /var/opt/UNItools/ ...
# 
# 	If strings requires a start/stop script, then it will have to be made
...
# 
# pkg_setup ftp://ftp.gnu.org/gnu/binutils/binutils-2.14.tar.gz 2.14 strings
# 
