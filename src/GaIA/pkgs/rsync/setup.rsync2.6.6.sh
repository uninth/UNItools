...
# cd /lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/rsync
# 
...
NAME="faster, flexible replacement for scp"

# The creator/copyright holder
VENDOR="Martin Pool <mbp@samba.org>"

# Local source location
SRC="/lan/ssi/projects/UNItools/src/Linux/2.4.21-20cpsmp/pkgs/rsync/rsync-2.6.6"
