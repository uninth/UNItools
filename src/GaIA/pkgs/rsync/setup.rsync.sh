...
# Konfiguration: /var/opt/UNItools/etc/rsync
# Dokumentation: /var/opt/UNItools/docs/rsync.2.6.6
# 
# Det er *ikke* programpakker i Linux format (pkg) men blot en
# installation af programmet rsync.
# 
#  1	Download programpakken rsync til /lan/ssi/projects/UNItools/src/Linux/2.4.21-20cpsmp/pkgs/rsync.
# 	Læs hvordan programpakken oversættes og installeres i dokumentationen
# 	for programpakken (typisk README og INSTALL).
# 
 	wget -N http://rsync.samba.org/ftp/rsync/rsync-2.6.6.tar.gz
# 
 	/bin/gtar xvzf rsync-2.6.6.tar.gz
# 
...
# 	som html, txt og pdf og gemmes i docs/rsync.2.6.6.  Se efter
...
# 	kopiere de relevante dokumenter til rsync.2.6.6.install.tmp.
# 
