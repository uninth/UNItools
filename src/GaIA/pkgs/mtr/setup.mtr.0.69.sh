...
# 
#
#                                      Wed Mar 26 15:54:45 CET 2014
# Preample
# --------
# This script is the documentation for how mtr 0.69 was downloaded,
...
# All configuration files:	/var/opt/UNItools/etc/mtr
# All relevant documentation:	/var/opt/UNItools/docs/mtr.0.69
# 
...
# cd /lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/mtr
# 
#  1	Download the package mtr, and read the package documentation,
...
# 
cat << "END_OF_CFG" > CFG
URL="ftp://ftp.bitwizard.nl/mtr/mtr-0.69.tar.gz"
PKG="mtr"
VER="0.69"
NAME="a network diagnostic tool"
VENDOR="Matt Kimball <mkimball@xmission.com> - see AUTHORS for a full list"
SRC="mtr-0.69"
ROOT="/var/opt/UNItools"
CONFIGURE="configure --without-gtk --prefix=/var/opt/UNItools --mandir=/var/opt/UNItools/share/man --sbindir=/var/opt/UNItools/bin"
BUILD="make"
...
# 
# 	If mtr is made with automake and configure then
# 
 	pkg_conbat -n ./CFG
# 
...
# 	/var/opt/UNItools
# 	If mtr requires something else to compile, please correct the
# 	section that writes to CFG.
# 	The new files are then moved to mtr.0.69.install.tmp - which
# 	will be wiped first.
# 	Copy extra files with ''install_more'' which sould add the files
# 	to /var/opt/UNItools/ ...
# 
# 	If mtr requires a start/stop script, then it will have to be made
...
# 
# pkg_setup ftp://ftp.bitwizard.nl/mtr/mtr-0.69.tar.gz 0.69 mtr
# 
