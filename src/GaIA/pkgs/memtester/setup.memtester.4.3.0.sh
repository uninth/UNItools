...
# 
#
#                                      Wed Mar 19 15:43:22 CET 2014
# Preample
# --------
# This script is the documentation for how memtester 4.3.0 was downloaded,
...
# All configuration files:	/var/opt/UNItools/etc/memtester
# All relevant documentation:	/var/opt/UNItools/docs/memtester.4.3.0
# 
...
# cd /lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/memtester
# 
#  1	Download the package memtester, and read the package documentation,
# 	usually README and INSTALL.
# 
# wget -N http://pyropus.ca/software/memtester/old-versions/memtester-4.3.0.tar.gz
# 
# /bin/gtar xvzf memtester-4.3.0.tar.gz
# 
...
VENDOR="http://pyropus.ca/software/memtester/old-versions/memtester-4.3.0.tar.gz"
...
# 
# 	edit Makefile so the memtester.8 will be installed without being zipped
...
# 	If memtester is made with automake and configure then
...
# 	/var/opt/UNItools
# 	If memtester requires something else to compile, please correct the
# 	section that writes to CFG.
# 	The new files are then moved to memtester.4.3.0.install.tmp - which
# 	will be wiped first.
# 	Copy extra files with ''install_more'' which sould add the files
# 	to /var/opt/UNItools/ ...
# 
# 	If memtester requires a start/stop script, then it will have to be made
...
# 
# pkg_setup http://pyropus.ca/software/memtester/old-versions/memtester-4.3.0.tar.gz 4.3.0 memtester
# 
