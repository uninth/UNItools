...
# Konfiguration: /var/opt/UNItools/etc/smtpclient
# Dokumentation: /var/opt/UNItools/docs/smtpclient.1.0.0
# 
# Det er *ikke* programpakker i Linux format (pkg) men blot en
# installation af programmet smtpclient.
# 
#  1	Download programpakken smtpclient til /lan/ssi/projects/UNItools/src/Linux/2.4.21-20cpsmp/pkgs/smtpclient.
...
# 	som html, txt og pdf og gemmes i docs/smtpclient.1.0.0.  Se efter
...
# 	kopiere de relevante dokumenter til smtpclient.1.0.0.install.tmp.
# 
