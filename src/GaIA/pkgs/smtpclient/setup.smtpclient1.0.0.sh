...
# cd /lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/smtpclient
# 
#  1	Download the package links, and read the package documentation,
# 	usually README and INSTALL.
# 
# wget -N ftp://www.ossp.org/pkg/tool/smtpclient/smtpclient-1.0.0.tar.gz
# 
# /bin/gtar xvzf smtpclient-1.0.0.tar.gz
# 
...
URL="ftp://www.ossp.org/pkg/tool/smtpclient/smtpclient-1.0.0.tar.gz"
PKG="smtpclient"
VER="1.0.0"

# Description used internally
NAME="smtpclient: simple SMTP client"

# The creator/copyright holder
VENDOR="http://www.engelschall.com/sw/smtpclient"

# Local source location
SRC="/lan/ssi/projects/UNItools/src/Linux/2.4.21-20cpsmp/pkgs/smtpclient/smtpclient-1.0.0"

# prefix for ''make install' Do not change
ROOT="/var/opt/UNItools"

# Arguments to configure, build command and installation command
CONFIGURE="configure --prefix=/var/opt/UNItools --mandir=/var/opt/UNItools/share/man --bindir=/var/opt/UNItools/bin --sbindir=/var/opt/UNItools/bin"
BUILD="make"
