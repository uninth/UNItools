...
/* Define to 1 if your build target is BSD. */
/* #undef HAVE_BSD */
...
/* Define to 1 if your build target is HP-UX. */
/* #undef HAVE_HPUX */
...
/* Define to 1 if your build target is Linux. */
#define HAVE_LINUX 1
...
/* Define to 1 if your build target is Solaris. */
/* #undef HAVE_SOLARIS */
