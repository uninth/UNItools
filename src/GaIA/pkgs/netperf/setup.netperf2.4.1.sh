...
# cd /lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/netperf
# 
#  1	Download the package links, and read the package documentation,
# 	usually README and INSTALL.
# 
# wget -N ftp://ftp.netperf.org/netperf/netperf-2.4.1.tar.gz
# 
# /bin/gtar xvzf netperf-2.4.1.tar.gz
# 
...
URL="ftp://ftp.netperf.org/netperf/netperf-2.4.1.tar.gz"
PKG="netperf"
VER="2.4.1"

# Description used internally
NAME="benchmark to measure various aspect of networking performance"

# The creator/copyright holder
VENDOR="rick jones - see AUTHORS"

# Local source location
SRC="/lan/ssi/projects/UNItools/src/Linux/2.4.21-20cpsmp/pkgs/netperf/netperf-2.4.1"
