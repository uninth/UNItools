...
# Konfiguration: /var/opt/UNItools/etc/netperf
# Dokumentation: /var/opt/UNItools/docs/netperf.2.4.1
# 
# Det er *ikke* programpakker i Linux format (pkg) men blot en
# installation af programmet netperf.
# 
#  1	Download programpakken netperf til /lan/ssi/projects/UNItools/src/Linux/2.4.21-20cpsmp/pkgs/netperf.
...
# 	som html, txt og pdf og gemmes i docs/netperf.2.4.1.  Se efter
...
# 	kopiere de relevante dokumenter til netperf.2.4.1.install.tmp.
# 
