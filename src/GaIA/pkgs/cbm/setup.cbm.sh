...
# Konfiguration: /var/opt/UNItools/etc/cbm
# Dokumentation: /var/opt/UNItools/docs/cbm.0.1
# 
# Det er *ikke* programpakker i Linux format (pkg) men blot en
# installation af programmet cbm.
# 
#  1	Download programpakken cbm til /home/projects/UNItools/src/Linux/2.4.21-20cpsmp/pkgs/cbm.
...
# 	som html, txt og pdf og gemmes i docs/cbm.0.1.  Se efter
...
# 	kopiere de relevante dokumenter til cbm.0.1.install.tmp.
# 
