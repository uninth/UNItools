...
# Konfiguration: /var/opt/UNItools/etc/links
# Dokumentation: /var/opt/UNItools/docs/links.1.00pre14
# 
# Det er *ikke* programpakker i Linux format (pkg) men blot en
# installation af programmet links.
# 
#  1	Download programpakken links til /lan/ssi/projects/UNItools/src/Linux/2.4.21-20cpsmp/pkgs/links.
# 	Læs hvordan programpakken oversættes og installeres i dokumentationen
# 	for programpakken (typisk README og INSTALL).
# 
# 	wget -N http://artax.karlin.mff.cuni.cz/~mikulas/links/download/links-1.00pre14.tar.gz
# 
# 	/bin/gtar xvzf links-1.00pre14.tar.gz
# 
...
# 	som html, txt og pdf og gemmes i docs/links.1.00pre14.  Se efter
...
# 	kopiere de relevante dokumenter til links.1.00pre14.install.tmp.
# 
