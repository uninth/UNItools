...
# cd /lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/links
# 
...
URL="http://artax.karlin.mff.cuni.cz/~mikulas/links/download/links-1.00pre14.tar.gz"
PKG="links"
VER="1.00pre14"

# Description used internally
NAME="Text WWW browser"

# The creator/copyright holder
VENDOR="Mikulas Patocka <mikulas@artax.karlin.mff.cuni.cz> and others. See AUTHORS"

# Local source location
SRC="/lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/links/links-1.00pre14"
