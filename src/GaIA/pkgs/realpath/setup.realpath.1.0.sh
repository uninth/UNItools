...
# 
#
#                                      Wed Mar 26 14:48:39 CET 2014
# Preample
# --------
# This script is the documentation for how realpath 1.0 was downloaded,
...
# All configuration files:	/var/opt/UNItools/etc/realpath
# All relevant documentation:	/var/opt/UNItools/docs/realpath.1.0
# 
...
# cd /lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/realpath
# 
#  1	Download the package realpath, and read the package documentation,
# 	usually README and INSTALL.
# 
# wget -N http://fakeurl-source-is-local
# 
# /bin/gtar xvzf fakeurl-source-is-local
# 
...
# 
cat << "END_OF_CFG" > CFG
URL="http://cpfw_pkgs.haugaard.net"
PKG="realpath"
VER="1.0"
NAME="Return the real path of a link"
...
# 
# 	If realpath is made with automake and configure then
# 
 	pkg_conbat -n ./CFG
# 
...
# 	/var/opt/UNItools
# 	If realpath requires something else to compile, please correct the
# 	section that writes to CFG.
# 	The new files are then moved to realpath.1.0.install.tmp - which
# 	will be wiped first.
# 	Copy extra files with ''install_more'' which sould add the files
# 	to /var/opt/UNItools/ ...
# 
# 	If realpath requires a start/stop script, then it will have to be made
...
# 
# pkg_setup http://fakeurl-source-is-local 1.0 realpath
# 
