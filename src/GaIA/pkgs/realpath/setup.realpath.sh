...
# Konfiguration: /var/opt/UNItools/etc/realpath
# Dokumentation: /var/opt/UNItools/docs/realpath.1.0
# 
# Det er *ikke* programpakker i Linux format (pkg) men blot en
# installation af programmet realpath.
# 
#  1	Download programpakken realpath til /lan/ssi/projects/UNItools/src/Linux/2.4.21-20cpsmp/pkgs/realpath.
# 	Læs hvordan programpakken oversættes og installeres i dokumentationen
# 	for programpakken (typisk README og INSTALL).
# 
# 	wget -N http://cpfw_pkgs.haugaard.net
# 
# 	/bin/gtar xvzf cpfw_pkgs.haugaard.net
# 
...
# 	som html, txt og pdf og gemmes i docs/realpath.1.0.  Se efter
...
# 	kopiere de relevante dokumenter til realpath.1.0.install.tmp.
# 
