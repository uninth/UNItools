...
# cd /lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/perl
# 
#  1	Download the package links, and read the package documentation,
# 	usually README and INSTALL.
# 
# wget -N http://ftp.activestate.com/ActivePerl/Linux/5.8/ActivePerl-5.8.7.815-i686-linux-2.2.17-gcc-211909.tar.gz
# 
# /bin/gtar xvzf ActivePerl-5.8.7.815-i686-linux-2.2.17-gcc-211909.tar.gz
# 
...
URL="http://ftp.activestate.com/ActivePerl/Linux/5.8/ActivePerl-5.8.7.815-i686-linux-2.2.17-gcc-211909.tar.gz"
PKG="perl"
VER="5.8.7.815"

# Description used internally
NAME="Practical Extraction and Report Language"

# The creator/copyright holder
VENDOR="Active State"

# Local source location
SRC="/lan/ssi/projects/UNItools/src/Linux/2.4.21-20cpsmp/pkgs/perl/ActivePerl-5.8.7.815-i686-linux-2.2.17-gcc-211909"

# prefix for ''make install' Do not change
ROOT="/var/opt/UNItools"

# Arguments to configure, build command and installation command
CONFIGURE="/bin/echo ok"
BUILD="make"
...
install:	
	...
	# flyt html -> /var/tmp, flyt tilbage efter kald af pkg_conbat
	# for at undgå konvertering af html til pdf
...
EOF
	...
	/bin/mv /var/tmp/html perl.5.8.7.815.install.tmp/var/opt/UNItools/docs/perl.5.8.7.815/
