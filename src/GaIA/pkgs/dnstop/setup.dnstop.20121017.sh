...
# 
#
#                                      Wed Mar 19 14:32:38 CET 2014
# Preample
# --------
# This script is the documentation for how dnstop 20121017 was downloaded,
...
# All configuration files:	/var/opt/UNItools/etc/dnstop
# All relevant documentation:	/var/opt/UNItools/docs/dnstop.20121017
# 
...
# cd /lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/dnstop
# 
#  1	Download the package dnstop, and read the package documentation,
# 	usually README and INSTALL.
# 
# wget -N http://dns.measurement-factory.com/tools/dnstop/src/dnstop-20121017.tar.gz
# 
# /bin/gtar xvzf dnstop-20121017.tar.gz
# 
...
VENDOR="http://dns.measurement-factory.com/tools/dnstop/src/dnstop-20121017.tar.gz"
...
# 
# 	If dnstop is made with automake and configure then
# 
 	pkg_conbat -n ./CFG
# 
...
# 	/var/opt/UNItools
# 	If dnstop requires something else to compile, please correct the
# 	section that writes to CFG.
# 	The new files are then moved to dnstop.20121017.install.tmp - which
# 	will be wiped first.
# 	Copy extra files with ''install_more'' which sould add the files
# 	to /var/opt/UNItools/ ...
# 
# 	If dnstop requires a start/stop script, then it will have to be made
...
# 
# pkg_setup http://dns.measurement-factory.com/tools/dnstop/src/dnstop-20121017.tar.gz 20121017 dnstop
# 
