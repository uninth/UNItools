...
# Konfiguration: /var/opt/UNItools/etc/lrzsz
# Dokumentation: /var/opt/UNItools/docs/lrzsz.0.12.20
# 
# Det er *ikke* programpakker i Linux format (pkg) men blot en
# installation af programmet lrzsz.
# 
#  1	Download programpakken lrzsz til /lan/ssi/projects/UNItools/src/Linux/2.4.21-20cpsmp/pkgs/lrzsz.
# 	Læs hvordan programpakken oversættes og installeres i dokumentationen
# 	for programpakken (typisk README og INSTALL).
# 
# 	wget -N http://freshmeat.net/redir/lrzsz/6021/url_tgz/lrzsz-0.12.20.tar.gz
# 
# 	/bin/gtar xvzf lrzsz-0.12.20.tar.gz
# 
...
# 	som html, txt og pdf og gemmes i docs/lrzsz.0.12.20.  Se efter
...
# 	kopiere de relevante dokumenter til lrzsz.0.12.20.install.tmp.
# 
