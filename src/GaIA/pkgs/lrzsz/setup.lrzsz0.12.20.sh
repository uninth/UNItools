...
# cd /lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/lrzsz
# 
...
URL="http://freshmeat.net/redir/lrzsz/6021/url_tgz/lrzsz-0.12.20.tar.gz"
PKG="lrzsz"
VER="0.12.20"

# Description used internally
NAME="XMODEM, YMODEM, ZMODEM (Batch) file send and receive"
