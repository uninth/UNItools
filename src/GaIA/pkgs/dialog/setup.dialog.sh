...
# Konfiguration: /var/opt/UNItools/etc/dialog
# Dokumentation: /var/opt/UNItools/docs/dialog.1.0-20051107
# 
# Det er *ikke* programpakker i Linux format (pkg) men blot en
# installation af programmet dialog.
# 
#  1	Download programpakken dialog til /lan/ssi/projects/UNItools/src/Linux/2.4.21-20cpsmp/pkgs/dialog.
...
# 
# 	dialog.1.0-20051107.install.tmp
# 
...
# 	som html, txt og pdf og gemmes i docs/dialog.1.0-20051107.  Se efter
...
# 	kopiere de relevante dokumenter til dialog.1.0-20051107.install.tmp.
# 
