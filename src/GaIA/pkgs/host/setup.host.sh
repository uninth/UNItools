...
# Konfiguration: /var/opt/UNItools/etc/host
# Dokumentation: /var/opt/UNItools/docs/host.991529
# 
# Det er *ikke* programpakker i Linux format (pkg) men blot en
# installation af programmet host.
# 
#  1	Download programpakken host til /lan/ssi/projects/UNItools/src/Linux/2.4.21-20cpsmp/pkgs/host.
...
# 	som html, txt og pdf og gemmes i docs/host.991529.  Se efter
...
# 	kopiere de relevante dokumenter til host.991529.install.tmp.
# 
