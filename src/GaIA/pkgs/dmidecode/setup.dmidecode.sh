...
# Konfiguration: /var/opt/UNItools/etc/dmidecode
# Dokumentation: /var/opt/UNItools/docs/dmidecode.2.8
# 
# Det er *ikke* programpakker i Linux format (pkg) men blot en
# installation af programmet dmidecode.
# 
#  1	Download programpakken dmidecode til /home/projects/UNItools/src/Linux/2.4.21-20cpsmp/pkgs/dmidecode.
# 	Læs hvordan programpakken oversættes og installeres i dokumentationen
# 	for programpakken (typisk README og INSTALL).
# 
# 	wget -N http://freshmeat.net/redir/dmidecode/36439/url_tgz/dmidecode-2.8.tar.gz
# 
# 	/bin/gtar xvzf dmidecode-2.8.tar.gz
# 
...
# 	som html, txt og pdf og gemmes i docs/dmidecode.2.8.  Se efter
...
# 	kopiere de relevante dokumenter til dmidecode.2.8.install.tmp.
# 
