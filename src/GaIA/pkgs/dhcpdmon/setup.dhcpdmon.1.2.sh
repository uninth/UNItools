...
# 
#
#                                      Wed Mar 19 14:02:56 CET 2014
# Preample
# --------
# This script is the documentation for how dhcping 1.2 was downloaded,
...
# All configuration files:	/var/opt/UNItools/etc/dhcping
# All relevant documentation:	/var/opt/UNItools/docs/dhcping.1.2
# 
...
# cd /lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/dhcping
# 
#  1	Download the package dhcping, and read the package documentation,
# 	usually README and INSTALL.
# 
# wget -N http://www.mavetju.org/download/dhcping-1.2.tar.gz
# 
# /bin/gtar xvzf dhcping-1.2.tar.gz
# 
...
PKG="dhcpdmon"
VER="1.2"
NAME="Monitor and restart dhcpdaemon upon faileures"
...
# 
# 	If dhcping is made with automake and configure then
# 
 	pkg_conbat -n ./CFG
# 
...
# 	/var/opt/UNItools
# 	If dhcping requires something else to compile, please correct the
# 	section that writes to CFG.
# 	The new files are then moved to dhcping.1.2.install.tmp - which
# 	will be wiped first.
# 	Copy extra files with ''install_more'' which sould add the files
# 	to /var/opt/UNItools/ ...
# 
# 	If dhcping requires a start/stop script, then it will have to be made
...
# 
# pkg_setup http://www.mavetju.org/download/dhcping-1.2.tar.gz 1.2 dhcping
# 
