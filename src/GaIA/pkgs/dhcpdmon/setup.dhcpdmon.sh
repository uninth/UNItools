...
# Konfiguration: /var/opt/UNItools/etc/dhcpdmon
# Dokumentation: /var/opt/UNItools/docs/dhcpdmon.1.0
# 
# Det er *ikke* programpakker i Linux format (pkg) men blot en
# installation af programmet dhcpdmon.
# 
#  1	Download programpakken dhcpdmon til /lan/ssi/projects/UNItools/src/Linux/2.4.21-20cpsmp/pkgs/dhcpdmon.
...
# 	som html, txt og pdf og gemmes i docs/dhcpdmon.1.0.  Se efter
...
# 	kopiere de relevante dokumenter til dhcpdmon.1.0.install.tmp.
# 
