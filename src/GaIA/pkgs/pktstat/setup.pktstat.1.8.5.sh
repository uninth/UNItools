...
# 
#
#                                      Mon Mar 24 17:09:06 CET 2014
# Preample
# --------
# This script is the documentation for how pktstat 1.8.5 was downloaded,
...
# All configuration files:	/var/opt/UNItools/etc/pktstat
# All relevant documentation:	/var/opt/UNItools/docs/pktstat.1.8.5
# 
...
# cd /lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/pktstat
# 
#  1	Download the package pktstat, and read the package documentation,
# 	usually README and INSTALL.
# 
# wget -N http://www.adaptive-enterprises.com.au/~d/software/pktstat/pktstat-1.8.5.tar.gz
# 
# /bin/gtar xvzf pktstat-1.8.5.tar.gz
# 
...
URL="http://www.adaptive-enterprises.com.au/~d/software/pktstat/pktstat-1.8.5.tar.gz"
PKG="pktstat"
VER="1.8.5"

# Description used internally
NAME="display packet activity on a crt"

# The creator/copyright holder
VENDOR="David Leonard, leonard@users.sourceforge.net"
...
# 
# 	If pktstat is made with automake and configure then
# 
 	pkg_conbat -n ./CFG
# 
...
# 	/var/opt/UNItools
# 	If pktstat requires something else to compile, please correct the
# 	section that writes to CFG.
# 	The new files are then moved to pktstat.1.8.5.install.tmp - which
# 	will be wiped first.
# 	Copy extra files with ''install_more'' which sould add the files
# 	to /var/opt/UNItools/ ...
# 
# 	If pktstat requires a start/stop script, then it will have to be made
...
# 
# pkg_setup http://www.adaptive-enterprises.com.au/~d/software/pktstat/pktstat-1.8.5.tar.gz 1.8.5 pktstat
# 
