...
# 
#
#                                      Tue Mar 18 15:01:51 CET 2014
# Preample
# --------
# This script is the documentation for how strace 4.5.12 was downloaded,
...
# All configuration files:	/var/opt/UNItools/etc/strace
# All relevant documentation:	/var/opt/UNItools/docs/strace.4.5.12
# 
...
# cd /lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/strace
# 
#  1	Download the package strace, and read the package documentation,
# 	usually README and INSTALL.
# 
# wget -N http://switch.dl.sourceforge.net/sourceforge/strace/strace-4.5.12.tar.bz2
# 
# /bin/gtar xvzf strace-4.5.12.tar.bz2
#
#tar xvf strace-4.5.12.tar
#
# 
...
# 
cat << "END_OF_CFG" > CFG
URL="http://switch.dl.sourceforge.net/sourceforge/strace/strace-4.5.12.tar.bz2"
PKG="strace"
VER="4.5.12"
NAME="strace"
VENDOR="http://switch.dl.sourceforge.net/sourceforge/strace/strace-4.5.12.tar.bz2"
SRC="strace-4.5.12"
...
# 
# 	If strace is made with automake and configure then
# 
 	pkg_conbat -n ./CFG
# 
...
# 	/var/opt/UNItools
# 	If strace requires something else to compile, please correct the
# 	section that writes to CFG.
# 	The new files are then moved to strace.4.5.12.install.tmp - which
# 	will be wiped first.
# 	Copy extra files with ''install_more'' which sould add the files
# 	to /var/opt/UNItools/ ...
# 
# 	If strace requires a start/stop script, then it will have to be made
...
# 
# pkg_setup http://switch.dl.sourceforge.net/sourceforge/strace/strace-4.5.12.tar.bz2 4.5.12 strace
# 
