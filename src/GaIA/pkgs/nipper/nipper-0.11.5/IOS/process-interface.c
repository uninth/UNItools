...
void processInterface(char *line, struct nipperConfig *nipper)
{
	...
	if ((strncmp(interfacePointer->name, "GigabitEthernet", 15) == 0) || (strncmp(interfacePointer->name, "FastEthernet", 12)) || (strncmp(interfacePointer->name, "Ethernet", 8) == 0) || (strncmp(interfacePointer->name, "Vlan", 4) == 0))
