...
# 
#
#                                      Wed Mar 19 15:46:54 CET 2014
# Preample
# --------
# This script is the documentation for how minicom 2.1 was downloaded,
...
# All configuration files:	/var/opt/UNItools/etc/minicom
# All relevant documentation:	/var/opt/UNItools/docs/minicom.2.1
# 
...
# cd /lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/minicom
# 
#  1	Download the package minicom, and read the package documentation,
# 	usually README and INSTALL.
# 
# wget -N http://alioth.debian.org/download.php/123/minicom-2.1.tar.gz
# 
# /bin/gtar xvzf minicom-2.1.tar.gz
# 
...
VENDOR="http://alioth.debian.org/download.php/123/minicom-2.1.tar.gz"
...
# 
# 	If minicom is made with automake and configure then
# 
 	pkg_conbat -n ./CFG
# 
...
# 	/var/opt/UNItools
# 	If minicom requires something else to compile, please correct the
# 	section that writes to CFG.
# 	The new files are then moved to minicom.2.1.install.tmp - which
# 	will be wiped first.
# 	Copy extra files with ''install_more'' which sould add the files
# 	to /var/opt/UNItools/ ...
# 
# 	If minicom requires a start/stop script, then it will have to be made
...
# 
# pkg_setup http://alioth.debian.org/download.php/123/minicom-2.1.tar.gz 2.1 minicom
# 
