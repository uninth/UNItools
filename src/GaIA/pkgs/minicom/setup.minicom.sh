...
# Konfiguration: /var/opt/UNItools/etc/minicom
# Dokumentation: /var/opt/UNItools/docs/minicom.2.1
# 
# Det er *ikke* programpakker i Linux format (pkg) men blot en
# installation af programmet minicom.
# 
#  1	Download programpakken minicom til /lan/ssi/projects/UNItools/src/Linux/2.4.21-20cpsmp/pkgs/minicom.
...
# 	som html, txt og pdf og gemmes i docs/minicom.2.1.  Se efter
...
# 	kopiere de relevante dokumenter til minicom.2.1.install.tmp.
# 
