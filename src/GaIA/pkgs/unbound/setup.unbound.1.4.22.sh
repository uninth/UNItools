...
# 
#
#                                     Tue Apr  8 18:34:33 CEST 2014
# Preample
# --------
# This script is the documentation for how unbound 1.4.22 was downloaded,
...
# All configuration files:	/var/opt/UNItools/etc/unbound
# All relevant documentation:	/var/opt/UNItools/docs/unbound.1.4.22
# 
...
# cd /lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/unbound
# 
#  1	Download the package unbound, and read the package documentation,
# 	usually README and INSTALL.
# 
wget -N http://unbound.nlnetlabs.nl/downloads/unbound-latest.tar.gz
# 
/bin/gtar xvzf unbound-latest.tar.gz
# 
...
SRC="unbound-1.4.22"
ROOT="/home/unbound"
CONFIGURE="configure --prefix=/home/unbound --mandir=/home/unbound/share/man --bindir=/home/unbound --sbindir=/home/unbound/bin --with-ldns=/home/unbound/"
BUILD="make"
...
# 
# 	If unbound is made with automake and configure then
# 
# 	pkg_conbat -n ./CFG
# 
...
# 	/var/opt/UNItools
# 	If unbound requires something else to compile, please correct the
# 	section that writes to CFG.
# 	The new files are then moved to unbound.1.4.22.install.tmp - which
# 	will be wiped first.
# 	Copy extra files with ''install_more'' which sould add the files
# 	to /var/opt/UNItools/ ...
# 
# 	If unbound requires a start/stop script, then it will have to be made
...
# 
# pkg_setup http://unbound.nlnetlabs.nl/downloads/unbound-latest.tar.gz 1.4.22 unbound
# 
