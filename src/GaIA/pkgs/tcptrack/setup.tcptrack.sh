...
# Konfiguration: /var/opt/UNItools/etc/tcptrack
# Dokumentation: /var/opt/UNItools/docs/tcptrack.1.1.4
# 
# Det er *ikke* programpakker i Linux format (pkg) men blot en
# installation af programmet tcptrack.
# 
#  1	Download programpakken tcptrack til /lan/ssi/projects/UNItools/src/Linux/2.4.21-20cpsmp/pkgs/tcptrack.
# 	Læs hvordan programpakken oversættes og installeres i dokumentationen
# 	for programpakken (typisk README og INSTALL).
# 
# 	wget -N http://freshmeat.net/redir/tcptrack/45771/url_tgz/tcptrack-1.1.5.tar.gz
# 
	/bin/rm -fr tcptrack-1.1.5
 	/bin/gtar xvzf tcptrack-1.1.5.tar.gz
# 
...
# 	som html, txt og pdf og gemmes i docs/tcptrack.1.1.4.  Se efter
...
# 	kopiere de relevante dokumenter til tcptrack.1.1.4.install.tmp.
# 
