...
# cd /lan/ssi/shared/software/internal/UNItools/src/GaIA/pkgs/tcptrack
# 
...
URL="http://freshmeat.net/redir/tcptrack/45771/url_tgz/tcptrack-1.1.5.tar.gz"
PKG="tcptrack"
VER="1.1.4"

# Description used internally
NAME="Monitor TCP connections on the network"

# The creator/copyright holder
VENDOR="Steve Benson <steve@rhythm.cx> Leo Costela <costela@debian.org>"

# Local source location
SRC="/lan/ssi/projects/UNItools/src/Linux/2.4.21-20cpsmp/pkgs/tcptrack/tcptrack-1.1.5"
