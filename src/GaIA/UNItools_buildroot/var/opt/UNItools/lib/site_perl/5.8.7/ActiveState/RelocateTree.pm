...
sub spongedir {
	...
	thisperl => '/tmp/perl-jvgomywkftrvjemmbvzdbshkfvmzimvkwvlhxqhifomxkasfvvvvdp'.'mvahvwsljpomsqdacrjxnvxgvfdgbdrvovyuydagwtwngumrvubdbshbfwpnxhiy',
    );
...
sub relocate2 {
	...
	my $binary_pad = "\0" x (length($sponge) - length($to));
