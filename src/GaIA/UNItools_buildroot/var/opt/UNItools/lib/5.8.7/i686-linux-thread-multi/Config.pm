...
tie %Config, 'Config', {
    archlibexp => '/var/opt/UNItools/lib/5.8.7/i686-linux-thread-multi',
    ...
    osvers => '2.2.17',
    path_sep => ':',
    privlibexp => '/var/opt/UNItools/lib/5.8.7',
    scriptdir => '/var/opt/UNItools/bin',
    sitearchexp => '/var/opt/UNItools/lib/site_perl/5.8.7/i686-linux-thread-multi',
    sitelibexp => '/var/opt/UNItools/lib/site_perl/5.8.7',
    so => 'so',
    useithreads => 'define',
